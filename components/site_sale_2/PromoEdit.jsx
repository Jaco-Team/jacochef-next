...
export class PromoEdit extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.promo_double.date1) {
      let original_promo = {
        promo_action: this.props.promo_action_list.find(
          (item) => parseInt(item.id) == parseInt(this.props.promo.promo_action),
        )?.id,
        promo_sale: this.props.promo_sale_list.find(
          (item) => parseInt(item.name) == parseInt(this.props.promo.count_promo),
        )?.id,
        itemsAdd: JSON.parse(this.props.promo.promo__items)
          ? JSON.parse(this.props.promo.promo__items)
          : [],
        itemsAddPrice: JSON.parse(this.props.promo.add_items_on_price)
          ? JSON.parse(this.props.promo.add_items_on_price)
          : [],
        ...
        where_order:
          parseInt(this.props.promo.city_id) > 0
            ? 1
            : parseInt(this.props.promo.point_id) > 0
              ? 2
              : 1,
      ...
      let copy_promo = {
        promo_action: this.props.promo_action_list.find(
          (item) => parseInt(item.id) == parseInt(this.props.promo_double.promo_action),
        )?.id,
        promo_sale: this.props.promo_sale_list.find(
          (item) => parseInt(item.name) == parseInt(this.props.promo_double.count_promo),
        )?.id,
        itemsAdd: JSON.parse(this.props.promo_double.promo__items)
          ? JSON.parse(this.props.promo_double.promo__items)
          : [],
        itemsAddPrice: JSON.parse(this.props.promo_double.add_items_on_price)
          ? JSON.parse(this.props.promo_double.add_items_on_price)
          : [],
        ...
        where_order:
          parseInt(this.props.promo_double.city_id) > 0
            ? 1
            : parseInt(this.props.promo_double.point_id) > 0
              ? 2
              : 1,
        ...
        if (value !== d1[index][1]) {
          if (Array.isArray(d1[index][1])) {
            if (value.length !== d1[index][1].length) {
              diffEntries.push([
                key,
                { current: JSON.stringify(value), undo: JSON.stringify(d1[index][1]) },
              ]);
            }
          } else {
    ...
    return (
      ...
      >
        <DialogTitle id="alert-dialog-title">
          Редактирование {this.props.promoName}
          <IconButton
