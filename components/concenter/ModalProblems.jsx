		...
		>
			...
			>
				<div>
					...
					<ul>
						{positions.map((item) => <li>{item.name}</li>)}
					</ul>
				</div>
				<FormControl component="fieldset">
					...
					>
						<FormControlLabel value="no" control={<Radio/>} label="Нет проблем"/>
						<FormControlLabel value="not-bring" control={<Radio/>} label="Не привезли"/>
						<FormControlLabel value="bring" control={<Radio/>} label="Привезли не то"/>
						<FormControlLabel value="non-marketable" control={<Radio/>} label="Не товарный внешний вид"/>
					</RadioGroup>
				</FormControl>
				<MyAutocomplite
					value={solution}
