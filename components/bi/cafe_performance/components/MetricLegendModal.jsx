...
function MetricLegendContent({ metric }) {
...
export default function MetricLegendModal({ open, onClose, metric, inline = false }) {
  if (inline) return <MetricLegendContent metric={metric} />;
  ...
  return (
    ...
    >
      ...
      >
        <MetricLegendContent metric={metric} />
      </DialogContent>
