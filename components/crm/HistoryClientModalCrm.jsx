...
import { order_types_all } from "@/components/site_clients/config";
import {
  Box,
  Button,
  CircularProgress,
...
import { useLoading } from "@/components/site_clients/useClientsLoadingContext";
...
import { delivery_types } from "@/components/site_clients/config";

dayjs.locale("ru");

function HistoryClientModalCrm({ canAccess, showAlert, openOrder, open, onClose }) {
...
export default memo(HistoryClientModalCrm);
