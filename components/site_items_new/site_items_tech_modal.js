...
export class SiteItemsModalTech extends React.Component {
  ...
  recalculateWeights() {
    ...
    this.setState({ all_w_brutto, all_w_netto, all_w });
  }
            ...
            >
              ...
              >
                ...
                <Grid
                  ...
                  style={
                    !this.props.acces?.marc_desc_full_edit && !this.props.acces?.marc_desc_full_view
                      ? { display: "none" }
                      : {}
                  }
                >
                ...
                <Grid
                  ...
                  style={
                    !this.props.acces?._edit && !this.props.acces?._view ? { display: "none" } : {}
                  }
                >
                  <MyCheckBox
                    label="Хит"
