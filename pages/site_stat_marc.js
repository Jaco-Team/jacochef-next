...
import { MyTextInput, MySelect, MyAutocomplite, MyCheckBox, MyDatePickerNew } from "@/ui/Forms";
...
class SiteStatMarc_ extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      // правка от 06.06.22
      colors: [
        0x679499, 0x2941a, 0x62941a, 0xff0000, 0x46bdc6, 0xffb6c1, 0x679499, 0x2941a, 0x62941a,
        0xff0000, 0x46bdc6, 0xffb6c1,
      ],
    };
  }
  ...
  renderGraphOrdersD(MyData) {
    ...
    function createSeries2(name, field, data) {
      ...
      data.map(function (item, key) {
        ...
        series2 = chart.series.push(am5xy.ColumnSeries.new(root, ser_settings));
  ...
  renderCountPos(MyData) {
    ...
    function createSeries2(name, field, data) {
      ...
      if (adv1.length != 0) {
        ...
        chart.get("colors").set("colors", [am5.color(0x6794dc)]);
      ...
      if (adv2.length != 0) {
        ...
        chart.get("colors").set("colors", [am5.color(0x6794da)]);
        ...
        >
          ...
          >
            <MyAutocomplite
              ...
              func={(event, data) => {
                this.setState({ choosePoint: data });
              }}
              multiple={true}
              label="Точка"
            />
          ...
          >
            <MySelect
              data={this.state.typesShow}
              value={this.state.typeShow}
              func={(event) => {
                this.setState({ typeShow: event.target.value });
              }}
              label="Как показать"
            />
          </Grid>
          ...
          >
            <MyCheckBox
              label="Показать акции"
              value={this.state.is_show_adv}
              func={this.changeChekBox.bind(this, "is_show_adv")}
            />
          </Grid>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.newUsersTable.all ? this.state.newUsersTable.all : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.newUsersTable.kassa ? this.state.newUsersTable.kassa : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.newUsersTable.center ? this.state.newUsersTable.center : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.newUsersTable.site ? this.state.newUsersTable.site : 0}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              ...
              <TableContainer component={Paper}>
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countOrdersTable.all ? this.state.countOrdersTable.all : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countOrdersTable.dev ? this.state.countOrdersTable.dev : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countOrdersTable.hall ? this.state.countOrdersTable.hall : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countOrdersTable.pic ? this.state.countOrdersTable.pic : 0}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              ...
              <TableContainer component={Paper}>
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.avgSumm.all ? this.state.avgSumm.all : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.avgSumm.dev ? this.state.avgSumm.dev : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.avgSumm.hall ? this.state.avgSumm.hall : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.avgSumm.pic ? this.state.avgSumm.pic : 0}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              ...
              <TableContainer component={Paper}>
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countPos.count_rolls ? this.state.countPos.count_rolls : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.countPos.count_pizza ? this.state.countPos.count_pizza : 0}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
          ...
          {this.state.typeShow != 1 ? null : (
            ...
            >
              ...
              <h5 style={{ textAlign: "center" }}>
                ушли - заказывали за 90 дней до указанного периода и больше не заказывали
              </h5>
              <h5 style={{ textAlign: "center" }}>
                вернулись - не заказывали 90 дней до указанного периода, сделали заказ в указанный
                период
              </h5>
              <h5 style={{ textAlign: "center" }}>
                вернулись и продолжают заказывать - не заказывали 90 дней до указанного периода,
                сделали заказ в указанный период и были заказы с окончания периода по вчерашний день
              </h5>
              <TableContainer component={Paper}>
                <Table>
                  <TableHead>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        ...
                        Заказывали с ${dayjs(this.state.date_start).subtract(90, "day").locale("ru").format("DD MMMM YYYY")}
                         по ${dayjs(this.state.date_start).locale("ru").format("DD MMMM YYYY")} и не сделал ни одного заказа
                          с ${dayjs(this.state.date_end).locale("ru").format("DD MMMM YYYY")} по ${dayjs(new Date()).locale("ru").format("DD MMMM YYYY")}`}
                          arrow
                        >
                          <Chip
                            label="?"
                      ...
                      <TableCell style={{ textAlign: "center" }}>
                        Вернулись и продолжают заказывать
                        <Tooltip
                          title={`
                          Заказывали с ${dayjs(this.state.date_start).locale("ru").format("DD MMMM YYYY")}
                         по ${dayjs(this.state.date_end).locale("ru").format("DD MMMM YYYY")} и не сделал ни одного заказа
                          с ${dayjs(this.state.date_start).subtract(90, "day").locale("ru").format("DD MMMM YYYY")} по ${dayjs(this.state.date_start).locale("ru").format("DD MMMM YYYY")}
                          и сделали заказ в промежутке с ${dayjs(this.state.date_end).locale("ru").format("DD MMMM YYYY")} по ${dayjs(new Date()).locale("ru").subtract(1, "year").format("DD MMMM YYYY")}`}
                          arrow
                        >
                          <Chip
                            label="?"
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.fakeUsers.lost_users ? this.state.fakeUsers.lost_users : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.fakeUsers.ret_users ? this.state.fakeUsers.ret_users : 0}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {this.state.fakeUsers.ret_users_more
                          ? this.state.fakeUsers.ret_users_more
                          : 0}
                      </TableCell>
                    </TableRow>
              ...
              >
                ...
                >
                  ...
                  <h5
                    ...
                    onClick={this.showStat.bind(this, "roll")}
                  >
                    Показать/Скрыть
                  </h5>
                ...
                >
                  ...
                  <h5
                    style={{ textAlign: "center", cursor: "pointer" }}
                    onClick={this.showStat.bind(this, "set")}
                  >
                    Показать/Скрыть
                  </h5>
                ...
                >
                  ...
                  <h5
                    style={{ textAlign: "center", cursor: "pointer" }}
                    onClick={this.showStat.bind(this, "pizza")}
                  >
                    Показать/Скрыть
                  </h5>
...
export default function SiteStatMarc() {
  return <SiteStatMarc_ />;
}
