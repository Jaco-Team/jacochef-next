...
class VendorModule_ extends React.Component {
  ...
  addItemCustom() {
    let item = this.state.allItems.find(
      (item1) => parseInt(item1.id) == parseInt(this.state.customAdd.id),
    );
  ...
  checkAddMail() {
    if (
      this.state.mailMail.length > 0 &&
      this.state.mailPoint !== null &&
      this.state.mailComment.length > 0
    ) {
      let thisMails = [...this.state.mails];
    ...
    return (
      <>
        ...
        <Dialog
          ...
          maxWidth={"md"}
          onClose={() => {
            this.setState({ modalItems: false, customAdd: 0 });
          }}
        ...
        >
          <DialogTitle
            ...
            className="button"
          >
            Товары поставщика {this.state.openVendor ? this.state.openVendor.name : ""}
            <IconButton
              onClick={() => {
                this.setState({ modalItems: false, customAdd: 0 });
              }}
                    ...
                    <TableRow style={{ height: 75 }}>
                      <TableCell>
                        <MyAutocomplite
                          ...
                          func={(event, value) => {
                            this.setState({ customAdd: value });
                          }}
                        />
                      </TableCell>
                      <TableCell>
                        <AddIcon
                          onClick={this.addItemCustom.bind(this)}
                          style={{ cursor: "pointer" }}
                        />
                      </TableCell>
                    </TableRow>
                      ...
                      >
                        ...
                        <TableCell>
                          <MySelect
                            data={this.state.nds}
                            value={item.nds}
                            func={this.changeNDS.bind(this, item.item_id)}
                          />
                        </TableCell>
                        <TableCell>
                          <CloseIcon
                            onClick={this.delItem.bind(this, item.item_id)}
                            style={{ cursor: "pointer" }}
                          />
                        </TableCell>
                      </TableRow>
          ...
          <DialogActions>
            <Button
              onClick={this.saveVendorItems.bind(this)}
              color="primary"
            >
              Сохранить
            </Button>
        ...
        >
          <DialogTitle
            ...
            className="button"
          >
            Поставщик {this.state.openVendor ? this.state.openVendor.name : ""}
            <IconButton
              onClick={() => {
                this.setState({ modalVendor: false });
              }}
              ...
              {this.state.openVendor ? (
                <>
                  ...
                  >
                    <MyTextInput
                      label="Наименование"
                      value={this.state.openVendor.name}
                      func={this.testChange.bind(this, "name")}
                    />
                  </Grid>
                  <Grid
                    size={{
                  ...
                  >
                    <MyTextInput
                      label="Описание"
                      value={this.state.openVendor.text}
                      func={this.testChange.bind(this, "text")}
                    />
                  </Grid>
                  <Grid
                    size={{
                  ...
                  >
                    <MyTextInput
                      ...
                      value={this.state.openVendor.min_price}
                      func={this.testChange.bind(this, "min_price")}
                    />
                  </Grid>
                  ...
                  >
                    <MyTextInput
                      label="ИНН"
                      value={this.state.openVendor.inn}
                      func={this.testChange.bind(this, "inn")}
                      disabled={true}
                    />
                  </Grid>
                  <Grid
                  ...
                  >
                    <MyTextInput
                      label="ОГРН"
                      value={this.state.openVendor.ogrn}
                      func={this.testChange.bind(this, "ogrn")}
                    />
                  </Grid>
                  ...
                  >
                    <MyTextInput
                      label="БИК"
                      value={this.state.openVendor.bik}
                      func={this.testChange.bind(this, "bik")}
                    />
                  </Grid>
                  <Grid
                    size={{
                  ...
                  >
                    <MyTextInput
                      label="РС"
                      value={this.state.openVendor.rc}
                      func={this.testChange.bind(this, "rc")}
                    />
                  </Grid>
                  ...
                  >
                    <MyTextInput
                      ...
                      value={this.state.openVendor.addr}
                      func={this.testChange.bind(this, "addr")}
                    />
                  </Grid>
                  ...
                  >
                    <MyCheckBox
                      label="Активность"
                      value={parseInt(this.state.openVendor.is_show) == 1 ? true : false}
                      func={this.testChange.bind(this, "is_show")}
                    />
                  </Grid>
                  <Grid
                    size={{
                  ...
                  >
                    <MyCheckBox
                      ...
                      value={parseInt(this.state.openVendor.bill_ex) == 1 ? true : false}
                      func={this.testChange.bind(this, "bill_ex")}
                    />
                  </Grid>
                  <Grid
                    size={{
                  ...
                  >
                    <MyCheckBox
                      label="Необходима картинка"
                      value={parseInt(this.state.openVendor.need_img_bill_ex) == 1 ? true : false}
                      func={this.testChange.bind(this, "need_img_bill_ex")}
                    />
                  </Grid>
                  ...
                  >
                    <MyAutocomplite
                      ...
                      value={this.state.vendorCities}
                      func={(event, value) => {
                        console.log(value);
                        this.setState({ vendorCities: value });
                        setTimeout(() => {
                          this.changeCityPoint();
                        }, 300);
                      }}
                  ...
                  >
                    <MyCheckBox
                      ...
                      value={parseInt(this.state.openVendor.is_priority) == 1 ? true : false}
                      func={this.testChange.bind(this, "is_priority")}
                    />
                  </Grid>
                          ...
                          >
                            ...
                            >
                              <MyAutocomplite
                                multiple={false}
                                label="Точка"
                                data={this.state.need_points}
                                value={mail.point_id}
                                func={this.changeMail.bind(this, "point_id", key)}
                              />
                            </Grid>
                            <Grid
                              size={{
                            ...
                            >
                              <MyTextInput
                                label="Почта"
                                value={mail.mail}
                                func={this.changeMail.bind(this, "mail", key)}
                              />
                            </Grid>
                            <Grid
                              size={{
                            ...
                            >
                              <Button
                                ...
                                color="primary"
                                style={{ width: "100%" }}
                                onClick={this.delMail.bind(this, key)}
                              >
                                <CloseIcon />
                              </Button>
                            </Grid>
                            ...
                            >
                              <MyTextInput
                                ...
                                value={mail.comment}
                                func={this.changeMail.bind(this, "comment", key)}
                                multiline={true}
                                maxRows={5}
                              />
                            </Grid>
                        ...
                        >
                          ...
                          >
                            <MyAutocomplite
                              ...
                              label="Точка"
                              data={this.state.need_points}
                              value={this.state.mailPoint}
                              func={this.changeMailNew.bind(this, "mailPoint", 0)}
                              onBlur={this.checkAddMail.bind(this)}
                            />
                          </Grid>
                          <Grid
                            size={{
                          ...
                          >
                            <MyTextInput
                              ...
                              func={this.changeMailNew.bind(this, "mailMail", 0)}
                              onBlur={this.checkAddMail.bind(this)}
                            />
                          </Grid>
                          <Grid
                          ...
                          >
                            <MyTextInput
                              label="Контактные данные"
                              value={this.state.mailComment}
                              func={this.changeMailNew.bind(this, "mailComment", 0)}
                              onBlur={this.checkAddMail.bind(this)}
                              multiline={true}
                              maxRows={5}
                            />
        ...
        <Dialog
          ...
          maxWidth={"md"}
          onClose={() => {
            this.setState({ modalVendorNew: false });
          }}
          aria-labelledby="alert-dialog-title"
          aria-describedby="alert-dialog-description"
        >
        ...
        >
          ...
          >
            <Button
              onClick={this.openModalVendorNew.bind(this)}
              variant="contained"
            >
              Добавить поставщика
            </Button>
              ...
              <Table>
                ...
                <TableBody>
                  {this.state.vendors.map((item, key) => (
                    <TableRow
                      key={key}
                      style={{ backgroundColor: parseInt(item.is_show) == 0 ? "#e5e5e5" : "#fff" }}
                    >
                      <TableCell>
                        <Typography
                          onClick={this.openModalVendor.bind(this, item)}
                      ...
                      <TableCell style={{ textAlign: "center" }}>
                        <DirectionsCarIcon
                          onClick={this.openModalItems.bind(this, item)}
                          style={{ cursor: "pointer" }}
                        />
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                      ...
                      <TableCell style={{ textAlign: "center" }}>
                        {parseInt(item.is_priority) == 1 ? <PriorityHighIcon /> : null}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
