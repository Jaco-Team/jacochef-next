        ...
        <Table>
          <TableHead>
            ...
            <TableRow>
              ...
              <TableCell></TableCell>
              <TableCell>
                Кол-во заготовок по накладным от числа до последней ревизии (не включая день
                последней ревизии)
              </TableCell>
              <TableCell>
                Кол-во заготовок по проданным позициям со списанием от числа до последней ревизии
                (не включая день последней ревизии)
              </TableCell>
              <TableCell>
                От выбранной ревизии до последней (не включая день последней ревизии)
              </TableCell>
