...
function IndicatorsPage() {
  ...
  const openModalRate_clients_driver = (
    type_modal,
    name_row,
    item_type,
    id,
            ...
            >
              ...
              >
                <Paper>
                  ...
                  >
                    <Tab
                      label="Таблица по месяцам"
                      value="table_month"
                    />
                    <Tab
                      label="Таблица по годам"
                      value="table_year"
                    />
                    <Tab
                      label="Настройки"
                                ...
                                <TableBody>
                                  {statFutureTimes.map((it, k) => (
                                    <TableRow key={k}>
                                      ...
                                      <TableCell>
                                        {it.update_list
                                          .map((item, index) => {
                                            if (item.type === "times") {
                                              const prevItem =
                                                index > 0 ? it.update_list[index + 1] : null;
                                                    ...
                                                    {value?.value === it.value ? (
                                                      <>
                                                        <span style={{ color: "#ff6b6b" }}>
                                                          {statFutureTimes[k + 1]?.update_list[ind]
                                                            ?.ball ?? 0}
                                                        </span>
                                      ...
                                      <TableCell>
                                        <IconButton onClick={() => openModalDeleteFut(it.id)}>
                                          <DeleteIcon />
                                        </IconButton>
                                      </TableCell>
                                    </TableRow>
                                ...
                                <TableBody>
                                  {statFutureTimes.map((it, k) => (
                                    <TableRow key={k}>
                                      ...
                                      <TableCell>
                                        <IconButton onClick={() => openModalDeleteFutDelete(it.id)}>
                                          <DeleteIcon />
                                        </IconButton>
                                      </TableCell>
                                    </TableRow>
                  ...
                  <>
                    ...
                    >
                      ...
                      <Grid size={{ xs: 12, sm: 6 }}>
                        <Button
                          variant="contained"
                          onClick={getTableDataYearDriver}
                        >
                          Показать
                        </Button>
                      </Grid>
