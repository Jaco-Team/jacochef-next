...
import { MySelect, MyCheckBox, MyTimePicker } from "@/ui/Forms";
    ...
    return (
      <>
        ...
        <Dialog
          ...
          onClose={() => this.setState({ confirmDialog: false, del_id: null, text_delete: "" })}
        >
          ...
          <DialogActions>
            <Button
              onClick={() => this.setState({ confirmDialog: false, del_id: null, text_delete: "" })}
            >
              Отмена
            </Button>
              ...
              >
                ...
                >
                  <MySelect
                    ...
                    value={this.state.chooseEvent}
                    func={this.changeEvent.bind(this)}
                    label="Событие"
                    is_none={false}
                  />
                </Grid>
                ...
                >
                  <MySelect
                    ...
                    value={this.state.eventPoint1}
                    func={this.changePoint1.bind(this)}
                    label="Точка"
                    is_none={false}
                  />
                </Grid>
                ...
                {parseInt(this.state.chooseEvent) !== 2 ? null : (
                  <>
                    ...
                    >
                      <MyTimePicker
                        value={this.state.timeStart2}
                        func={this.changeTimeStart2.bind(this)}
                    ...
                    >
                      <MyTimePicker
                        value={this.state.timeEnd2}
                        func={this.changeTimeEnd2.bind(this)}
                ...
                >
                  <MyCheckBox
                    value={this.state.everyYear1}
                    func={this.changeEveryYear1.bind(this)}
                    label="Каждый год"
                  />
                </Grid>
              </Grid>
                ...
                {this.state.dayEvents.map((item, key) => (
                  <ListItem key={item.id || `d${key}`}>
                    ...
                    {!(parseInt(item.type) === 4 || parseInt(item.type) === 6) && (
                      <CloseIcon
                        color="primary"
                        onClick={this.openConfigDialog.bind(this, item)}
        ...
        >
          ...
          >
            <MySelect
              ...
              func={this.changeMounth.bind(this)}
              label="Месяц"
              is_none={false}
            />
          </Grid>
          ...
          >
            <MySelect
              ...
              func={this.changeYear.bind(this)}
              label="Год"
              is_none={false}
            />
          </Grid>
                        ...
                        <TableRow key={`y${key}-${m_key}`}>
                          {month.map((day, k) => (
                            <TableCell
                              ...
                              style={{
                                color: day.dir ? "yellow" : day.holy ? "#c03" : "#000",
                                height: "6vw",
                                position: "relative",
                              }}
