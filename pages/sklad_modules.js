...
class SkladModules_ extends React.Component {
  ...
  async openModal_param(mark_param, id) {
    ...
    if (mark_param === "edit_param") {
      ...
      res.param.module_id =
        res.param.modules.find((module) => parseInt(module.id) === parseInt(res.param.module_id)) ??
        0;
    ...
    return (
      <>
        ...
        <JParamModal
          ...
          onClose={() =>
            this.setState({ modalDialog_param: false, param: null, param_name: "", method: "" })
          }
          ...
          >
            {this.canEdit("app_params") && (
              <Button
                ...
                color="primary"
                style={{ whiteSpace: "nowrap" }}
                onClick={this.openModal_param.bind(this, "add_param", null)}
              >
                              ...
                              it.params?.length ? (
                                <React.Fragment key={key}>
                                  <TableRow
                                    ...
                                    onClick={(e) => {
                                      if (
                                        !e.currentTarget.querySelector("li")?.contains(e.target)
                                      ) {
                                        this.setState((prev) => ({
                                          expandedItems: {
                                            ...prev.expandedItems,
                                  ...
                                  >
                                    ...
                                    <TableCell>
                                      <ExpandMoreIcon
                                        sx={{
                                          transform: this.state.expandedItems[it.id]
                                            ? "rotate(180deg)"
                                            : "rotate(0deg)",
                                  ...
                                  {this.state.expandedItems[it.id] &&
                                    it.apps.map((param, k) => (
                                      <TableRow
                                        hover
                                        key={k}
                                      ...
                                      >
                                        ...
                                        <TableCell sx={{ textAlign: "center" }}>
                                          {this.canEdit("app_params") && (
                                            ...
                                            >
                                              <EditIcon
                                                onClick={this.openModal_param.bind(
                                                  this,
                                                  "edit_param",
                                                  param.id,
                                                )}
