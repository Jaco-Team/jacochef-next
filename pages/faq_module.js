        ...
        <DialogContent style={{ paddingBottom: 10, paddingTop: 10 }}>
          ...
          >
            ...
            >
              <TextEditor22
                id="EditorNew"
                value={this.state.itemView?.text}
                refs_={this.myRef_view}
                toolbar={false}
                menubar={false}
              />
            </Grid>
...
class FAQ_Modal extends React.Component {
  ...
  save() {
    ...
    if (
      (!this.myRef.current || this.myRef.current.getContent().length === 0) &&
      (this.props.type === "art" || this.props.type === "art_edit")
    ) {
      this.setState({
        openAlert: true,
        err_status: false,
      ...
      <>
        ...
        >
          ...
          <DialogContent
            ...
            sx={{ fontWeight: "bold" }}
          >
            Точно удалить {type === "section_edit" ? "данный раздел ?" : "данную статью ?"}
          </DialogContent>
          <DialogActions>
            <Button
              autoFocus
              ...
              >
                ...
                {type === "art" || type === "art_edit" ? (
                  ...
                  >
                    <TextEditor22
                      id="EditorNew"
                      func={this.changeEditor.bind(this)}
                ...
                {(type === "art" || type === "art_edit") &&
                this.state.item?.hist &&
                parseInt(acces?.show_hist) ? (
                  <Grid
                    size={{
                      xs: 12,
                      sm: 12,
        ...
        if (item.arts.length) {
          item.arts = item.arts.filter((it) => {
            if (
              ...
              it.text.toLowerCase().includes(searchItem.toLowerCase())
            ) {
              return it;
            }
          });
    ...
    return (
      <>
        ...
        <FAQ_Modal
          ...
          save={
            this.state.type === "section" || this.state.type === "section_edit"
              ? this.saveSection.bind(this)
              : this.saveArt.bind(this)
          }
        ...
        >
          ...
          >
            <Button
              onClick={this.openModal_add.bind(this, "Новый раздел", "section")}
              variant="contained"
            >
              Добавить раздел
            </Button>
          ...
          >
            <Button
              onClick={this.openModal_add.bind(this, "Новая статья", "art")}
              variant="contained"
            >
              Добавить статью
            </Button>
                    ...
                    <TableBody>
                      {item.arts.map((it, k) => (
                        <TableRow
                          ...
                          key={k}
                          style={{
                            backgroundColor: parseInt(it.status) === 2 ? "#fadadd" : "#fff",
                          }}
                        >
                          <TableCell>{k + 1}</TableCell>
