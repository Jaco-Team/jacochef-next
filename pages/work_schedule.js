            ...
            {this.props.test.map((item, key) =>
              item.row == 'header' ? (
                ...
                <TableRow key={key} style={{ backgroundColor: item?.color ? '#D3D3D3' : '#fff'}}>
                  ...
                  <TableCell 
                    style={{ textAlign: 'center', cursor: item.data.app_type == 'dir' && this.props.kind == 'dir' ? 'pointer' : 'default', backgroundColor: this.props.numberChoose == 2 && item.data.app_type == 'dir' ? '#e5e5e5' : '#fff' }} 
                    onClick={ this.props.numberChoose == 2 && item.data.app_type == 'dir' ? this.props.openModalDirBonus.bind(this, item.data.id, item.data.smena_id, item.data.app_id, this.props.numberChoose, item.data) : () => {} } 
