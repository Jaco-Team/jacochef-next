              ...
              item.row == 'header' ? (
                ...
                <TableRow key={key} style={{ backgroundColor: item?.color ? '#D3D3D3' : '#fff'}}>
                  ...
                  <TableCell 
                    ...
                    onClick={ this.props.numberChoose == 2 && (this.props.kind == 'dir' || this.props.kind == 'mega_dir') && item.data.app_type == 'dir' ? this.props.openModalDirBonus.bind(this, item.data.id, item.data.smena_id, item.data.app_id, this.props.numberChoose, item.data) : () => {} } 
