...
import { MyAutocomplite, MyTextInput, MySelect, MyCheckBox } from "@/ui/Forms";
    ...
    return (
      <>
        ...
        >
          ...
          >
            <Button
              onClick={this.openModal.bind(this, "new")}
              variant="contained"
            >
              Добавить точку
            </Button>
              ...
              >
                ...
                >
                  <MyCheckBox
                    ...
                    value={
                      this.state.data
                        ? parseInt(this.state.data.is_active) == 1
                          ? true
                          : false
                        : false
                    }
...
export default function CafeDirEdit() {
  return <CafeDirEdit_ />;
}
