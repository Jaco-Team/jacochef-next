...
import RasBillAndCook_ from '@/components/ras_bill_and_cook/RasBillAndCook_';
...
export async function getServerSideProps({ req, res, query }) {
  ...
  const resultRevs = await getDataSSR("ras_bill_and_cook", "get_rev_list", req.headers.cookie, data);
