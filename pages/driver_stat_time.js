    ...
    return (
      ...
      >
        <DialogTitle style={{ display: "flex" }}>
          ...
          <Typography
            style={{ fontWeight: "bold" }}
          >{`Курьер: ${this.state.order?.name ?? ""}`}</Typography>
          <IconButton
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    {parseInt(this.state.dop_show) == 0 ? (
                      false
                    ) : (
                      <TableCell align="center">Вовремя и в радиусе</TableCell>
                    )}
                    {parseInt(this.state.dop_show) == 0 ? (
                      false
                    ) : (
                      <TableCell align="center">В радиусе</TableCell>
                    )}
                    {parseInt(this.state.dop_show) == 0 ? (
                      false
                    ) : (
                      <TableCell align="center">Не вовремя и не в радиусе</TableCell>
                    )}
                  </TableRow>
                </TableHead>
                <TableBody>
                  ...
                  <TableBody>
                    {this.state.orders.map((row) => (
                      <TableRow
                        ...
                        onClick={this.openOrder.bind(this, row)}
                      >
