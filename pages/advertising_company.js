...
import { MyTextInput, MyDatePickerNew, MySelect, MyAutocomplite, MyCheckBox } from "@/ui/Forms";
                    ...
                    : this.state.adv_actual.map((item, key) => (
                        <TableRow key={key}>
                          ...
                          <TableCell style={{ textAlign: "center" }}>
                            {item.choosePoint.map((it, k) => (
                              <React.Fragment key={k}> {it.name} </React.Fragment>
                            ))}
                          </TableCell>
                          <TableCell style={{ textAlign: "center" }}>{item.promo} </TableCell>
                          <TableCell style={{ textAlign: "center" }}>
                            {" "}
                            <CloseIcon onClick={this.delAdv.bind(this, item.id)} />{" "}
                          </TableCell>
                        </TableRow>
                      ))}
                </TableBody>
...
export default function AdvertisingCompany() {
  return <AdvertisingCompany_ />;
}
